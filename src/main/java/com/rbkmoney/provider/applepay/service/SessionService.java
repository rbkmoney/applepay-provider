...
public class SessionService {
    ...
    private Request prepareRequest1(String validationUrl) {
        RequestBody body = RequestBody.create(MediaType.parse("Content-type: application/json;charset=utf-8"), "{\n" +
                ...
                "}");
        return new Request.Builder().url(prepareUrl(validationUrl)).method("POST", body).build();
    }
